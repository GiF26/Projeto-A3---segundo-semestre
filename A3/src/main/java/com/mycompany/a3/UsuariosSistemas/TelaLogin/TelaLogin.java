...
public class TelaLogin extends JFrame {
    ...
    public static UsuarioSistema usuarioSistema = new UsuarioSistema();
    ...
    private void initComponents() {
            ...
            .addGroup(jpnFieldsLayout.createSequentialGroup()
                .addGroup(jpnFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jpnFieldsLayout.createSequentialGroup()
                        .addGroup(jpnFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jpnFieldsLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(lblCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jpnFieldsLayout.createSequentialGroup()
                                .addGap(91, 91, 91)
                ...
                .addGroup(jpnFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpnFieldsLayout.createSequentialGroup()
                        .addGroup(jpnFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnCadConsumidor, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
        ...
        jpnFieldsLayout.setVerticalGroup(
            ...
            .addGroup(jpnFieldsLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jpnFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnCadPrestador, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jpnFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                ...
                .addGroup(jpnFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnCadConsumidor, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(29, 29, 29)
    ...
    private boolean validaLogin(){
        ...
        String sql = "SELECT ID, CPF, SENHA, TIPOUSUARIO" +
                    " FROM usuariossistema" + 
                    " WHERE CPF = " + txtEmail.getText() + 
        ...
        try (Connection con = configConexao.getConexao()) {
            try (PreparedStatement ps = con.prepareStatement(sql);
                ...
                if(rs.next()){
                    ...
                    usuarioSistema.setTipoUsuario(rs.getInt("TIPOUSUARIO"));
                    return true;
                }
            }
